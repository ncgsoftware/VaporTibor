...
final class BlogPostModel: ViperModel {
    ...
    struct FieldKeys {
        ...
        static var categoryId: FieldKey { "categoryId" }
    }
...
extension BlogPostModel: ApiRepresentable {
    ...
    var listContent: ListItem {
        .init(id: self.id!, title: self.title, slug: self.slug, image: self.image, excerpt: self.excerpt, date: self.date)
    }
    
    var getContent: GetContent {
        .init(id: self.id!, title: self.title, slug: self.slug, image: self.image, excerpt: self.excerpt, date: self.date, content: self.content)
    }
